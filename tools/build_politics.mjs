...
C(2026,'NLD','Willem-Alexander',king,'Dick Schoof',pm,[P('Parteilose','independent','Dick Schoof'),P('VVD','liberal','Dilan Yeşilgöz;Sophie Hermans;Eelco Heinen'),P('D66','liberal','Rob Jetten;Rob Paternotte'),P('PVV','national','Geert Wilders;Fleur Agema')]);
